...
subtest "proxies and flog_messages" => sub {
  ...
  is($proxprox->flog_messages("proxprox"), "A: B: C: D: E: proxprox", 'flog on proxprox');

  is($logger->flog_messages({ prefix => 'Z: ' }, "root"), "A: Z: root", 'flog on root with prefix');
  is($proxy->flog_messages({ prefix => 'Z: ' }, "proxy"), "A: B: C: Z: proxy", 'flog on proxy with prefix');
  is($proxprox->flog_messages({ prefix => 'Z: ' }, "proxprox"), "A: B: C: D: E: Z: proxprox", 'flog on proxprox with prefix');
};
